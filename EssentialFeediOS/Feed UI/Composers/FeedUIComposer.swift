...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader, imageLoader: FeedImageDataLoader) -> FeedViewController {
        ...
        presentationAdapter.presenter = FeedPresenter(feedView: FeedViewAdapter(controlller: feedController, imageLoader: imageLoader), loadingView: WeakRefVirtualProxy(refreshController))
